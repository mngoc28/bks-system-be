    ...
    public function run(): void
    {
        ...
        foreach ($partnerUserIds as $userId) {
            ...
            DB::table('partner_info')->insert([
                ...
                'company_name' => $faker->optional(0.7)->randomElement($companyNames),
                'phone'        => $faker->optional(0.9)->phoneNumber(),
                'website'      => $faker->optional(0.5)->url(),
                'description'  => $faker->optional(0.6)->randomElement($descriptions),
                'image_1'      => $faker->optional(0.6)->imageUrl(800, 600, 'business'),
                'image_2'      => $faker->optional(0.4)->imageUrl(800, 600, 'business'),
                'image_3'      => $faker->optional(0.3)->imageUrl(800, 600, 'business'),
